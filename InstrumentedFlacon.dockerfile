...
# Flacon with AFL++ and AddressSanitizer
RUN set -ux && \
    mv build_type_AddressSanitizer.cmake flacon/cmake/build_type.cmake && \
    cd flacon && cmake -DCMAKE_C_COMPILER=afl-cc -DCMAKE_CXX_COMPILER=afl-c++ . \
